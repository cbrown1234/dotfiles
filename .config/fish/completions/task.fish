...
#
# url = "https://raw.githubusercontent.com/go-task/task/main/completion/fish/task.fish"
# with request.urlopen(url) as response:
#     content = response.read().decode('utf-8')
#
# cog.outl(f"# Content pulled by cog script from {url}")
# cog.outl(content)
# ]]]
# Content pulled by cog script from https://raw.githubusercontent.com/go-task/task/main/completion/fish/task.fish
